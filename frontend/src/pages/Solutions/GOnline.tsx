...
export const GOnline: React.FC = () => {
  ...
  //   const benefits = t('solutions.gOnline.benefits', { returnObjects: true }) as Array<{title: string; description: string}>;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedElement animation="fade-right" scrollTrigger once>
              <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 mb-8 tracking-tight">
                {t('solutions.gOnline.perfectFor.title')}
              </h2>
